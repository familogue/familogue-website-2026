    ...
    <footer className="x-global-footer">
      <div className="x-row">
        ...
        <div className="x-col3">
          ...
          <p><Link href="https://wa.me/17789910902" target="_blank" rel="noopener noreferrer"><WhatsAppIcon />WhatsApp</Link></p>
          <p>{tNav('telephone')}: <Link href="tel:+17789910902">+1 (778) 991-0902</Link></p>
